function [clusters, clusterCenters, idx] = kMeansClustering(dataSet,numClusters,numIterations)
...
%         disp(strcat('Iteration:',{' '},string(iter)));
        ...
        for i = 1:numClusters
            ...
            temp_idx = find(dataSetAssignments(:,dataDim+1)==i);
            idx(temp_idx) = i;
        end
